...
var ComponentManager = (function () {
    ...
    _createClass(ComponentManager, [{
        ...
        value: function registerComponent(object, initializer) {
            var type = arguments[2] === undefined ? ComponentType.Static : arguments[2];
            var returnDetails = arguments[3] === undefined ? false : arguments[3];
            ...
            var component = { type: type, object: object };
        ...
        value: function addComponentToEntity(entity, componentId) {
        ...
        value: function removeComponentFromEntity(entity, componentId) {
            if (typeof entity !== 'object' || entity === null) {
                return;
            }
...
var EntityManager = (function () {
    function EntityManager() {
        ...
        var entityFactory = arguments[1] === undefined ? new EntityFactory() : arguments[1];
        var systemManager = arguments[2] === undefined ? new SystemManager() : arguments[2];
        var componentManager = arguments[3] === undefined ? new ComponentManager() : arguments[3];
        var eventHandler = arguments[4] === undefined ? new EventHandler() : arguments[4];
    ...
    _createClass(EntityManager, [{
        ...
        value: function registerComponent(object, initializer) {
            ...
            var component = this.componentManager.registerComponent(object, type);

            if (type === ComponentType.Static) {
                this.entities.forEach(function (entity) {
                    return entity[component] = _this.componentManager.newComponent(object);
                });
            }
        ...
        value: function increaseCapacity() {
            ...
            for (var i = this.capacity / 2; i < this.capacity; ++i) {
                ...
                try {
                    for (var _iterator5 = this.componentManager.getComponents()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        var _step5$value = _slicedToArray(_step5.value, 2);

                        var key = _step5$value[0];
                        var component = _step5$value[1];
        ...
        key: 'addEntity',
        value: function addEntity(components) {
            ...
            var entityId = this.getFirstUnusedEntity();
            ...
            var componentKeys = this.componentManager.getComponents().keys();
            ...
            try {
                for (var _iterator6 = componentKeys[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        value: function deleteEntity(entity) {
            ...
            try {
                for (var _iterator7 = componentKeys[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    _createClass(EntityFactory, [{
        ...
        value: function create(entityManager) {
            ...
            for (var i = 0; i < count; ++i) {
                var entity = entityManager.addEntity(components, true);
...
var SystemManager = (function () {
    ...
    _createClass(SystemManager, [{
        ...
        value: function removeSystem(system) {
            ...
            try {
                for (var _iterator10 = this.systems.values()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                    var typeSystem = _step10.value;
                    var _iteratorNormalCompletion11 = true;
                    var _didIteratorError11 = false;
                    var _iteratorError11 = undefined;

                    try {
                        for (var _iterator11 = typeSystem.keys()[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
        ...
        value: function getSystem(system) {
            ...
            try {
                for (var _iterator12 = this.systems.values()[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                    var typeSystem = _step12.value;
                    var _iteratorNormalCompletion13 = true;
                    var _didIteratorError13 = false;
                    var _iteratorError13 = undefined;

                    try {
                        for (var _iterator13 = typeSystem.keys()[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
