...
describe('SystemManager', function() {
    describe('registerSystem(callback, components, type, selector)', () => {
        ...
        it('registers a system under the correct type', () => {
            ...
            this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.Init, SelectorType.GetWith);
            ...
            this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.CleanUp, SelectorType.GetWith);
        ...
        it('returns the registered sytems id', () => {
            ...
            system = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.CleanUp);
        ...
        it('registers a system with the correct [type] and [selector]', () => {
            let initSystem    = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.Init, SelectorType.Get);
            let logicSystem   = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.Logic, SelectorType.GetWith);
            let renderSystem  = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.Render, SelectorType.GetWithOnly);
            let cleanUpSystem = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.CleanUp, SelectorType.GetWithout);
        ...
        it('registers a system with type SystemType.Logic if [type] is omitted or not a SystemType', () => {
            ...
            this.systemManager.registerSystem(() => { }, 1 | 2, 999999999);
            ...
            this.systemManager.registerSystem(() => { }, 1 | 2, 4);
            ...
            this.systemManager.registerSystem(() => { }, 1 | 2, -1);
        ...
        it('registers a system with selector SelectorType.GetWith if [selector] is omitted or not a SelectorType', () => {
            ...
            system = this.systemManager.registerSystem(() => { }, 1 | 2, SystemType.Render, 'not a selector type');
        ...
        it('sets [components] to 0 and [selector] to SelectorType.Get if components is omitted or not an integer', () => {
            ...
            systemId = this.systemManager.registerSystem(() => { }, 1.2);
