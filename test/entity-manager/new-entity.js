...
describe('EntityManager', function() {
    describe('newEntity(components)', () => {
        ...
        it('adds and returns an object containing an id and corresponding entity, given correct [components] input', () => {
        ...
        it('correctly creates an entity given an array of component names (as define in the [componentLookup])', () => {
